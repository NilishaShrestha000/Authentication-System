...
const style = {
    ...
    topic: "text-md lg:text-2xl text-orange-400 font-bold"
            ...
            <div className={style.wrapper}>
                ...
                <div className={style.header}>
                    ...
                    <div className=" flex  flex-col">
                        <p className="flex gap-2 items-center"><GrPhone /><a href="https://wa.me/9779863034097" className="text-lg lg:text-xl hover:text-orange-400 font-semibold"> 9863034977</a> </p>
